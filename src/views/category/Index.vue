    ...
    <div class="container-fluid mb-5 mt-4">
                ...
                >
                    <div class="card h-100 border-0 rounded shadow">
                        <div class="card-body text-center">
                            ...
                            <hr />
                            <label class="font-weight-bold" style="color: #3f7b70">{{ category.name }}</label>
                        </div>
                    </div>
                </router-link>
            </div>
        ...
        <div v-else class="row">
            <div class="col-md-2 col-sm-4 col-6 mb-3" v-for="loader in ContentLoader" v-bind:key="loader">
                <ContentLoader viewBox="0 0 135 140" :speed="2" primaryColor="#fafafa" secondaryColor="#e2e8f0" data-aos="fade-up" data-aos-once="true">
